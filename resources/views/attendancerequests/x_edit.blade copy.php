            ...
            ">
                ...
                <form action="{{ route('attendancerequests.update', $requestData->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="time" name="clock_in" id="clock_in" value="{{ old('clock_in', \Carbon\Carbon::parse($requestData->clock_in)->format('H:i')) }}" class="border-gray-300 rounded-md shadow-sm mt-1 block w-full">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="time" name="clock_out" id="clock_out" value="{{ old('clock_out', \Carbon\Carbon::parse($requestData->clock_out)->format('H:i')) }}" class="border-gray-300 rounded-md shadow-sm mt-1 block w-full">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('attendancerequests.reject', $requestData->id) }}" class="bg-red-500 text-white px-4 py-2 rounded-md">却下</a>
                    </div>
                </form>
