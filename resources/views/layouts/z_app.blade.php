...
<body class="font-sans antialiased bg-gradient-to-b from-indigo-50 via-white to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-gray-800 dark:text-gray-100">
    ...
    <div x-data="{ open: false }" class="min-h-screen flex flex-col md:flex-row relative transition-all duration-300">
        ...
        >
            <!-- Header -->
            @isset($header)
                <header class="bg-white dark:bg-gray-800 shadow fixed w-full md:static z-30 border-b border-indigo-100 dark:border-gray-700">
                    <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 h-14 flex items-center">
                        <h1 class="text-lg font-semibold text-indigo-700 dark:text-indigo-400">{{ $header }}</h1>
                    </div>
                </header>
            @endisset
