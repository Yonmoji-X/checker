                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('attendancerequests.create')" :active="request()->routeIs('attendancerequests.create')">
                                    {{ __('事後申請') }}
                                </x-dropdown-link>
                                @if (auth()->user()->role === 'admin')
                                <x-dropdown-link :href="route('attendancerequests.index')" :active="request()->routeIs('attendancerequests.index')">
                                    {{ __('申請一覧') }}
                                </x-dropdown-link>
                                @endif
                            </x-slot>
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="mb-2">
                <x-responsive-nav-link :href="route('records.create')" :active="request()->routeIs('records.create')">
                    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline">
                        {{ __('出退勤') }}
                    </button>
            ...
            <div class="border-b border-gray-200 dark:border-gray-700 pb-2 mb-2">
                <x-responsive-nav-link :href="route('attendancerequests.create')" :active="request()->routeIs('attendancerequests.create')">
                    {{ __('申請') }}
                </x-responsive-nav-link>
                @if (auth()->user()->role === 'admin')
                    <x-responsive-nav-link :href="route('attendancerequests.index')" :active="request()->routeIs('attendancerequests.index')">
                        {{ __('申請一覧') }}
                    </x-responsive-nav-link>
                @endif
            </div>
