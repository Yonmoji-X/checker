...
<nav x-data="{ open: false }" class="fixed top-0 left-0 w-full z-50">
    ...
    <!-- 上部バー（タブレット以下で表示） -->
    <div class="md:hidden flex items-center justify-between bg-white h-14 p-4">
    <!-- <div class="md:hidden flex items-center justify-between bg-gray-800 text-white h-14 p-4"> -->
    <!-- <div class="md:hidden flex items-center justify-between text-white h-14 p-4" style="background-color: #AFDFE4;"> -->
        ...
        <button @click="open = !open" class="focus:outline-none bg-white">
        <!-- <button @click="open = !open" class="focus:outline-none bg-gray-800"> -->
    ...
    <aside
        ...
        class="fixed md:translate-x-0 transition-transform duration-200 ease-in-out
               top-0 left-0 w-64 h-full bg-gray-800 text-gray-100 flex flex-col justify-between z-50"
    >
    <!-- <aside
        :class="{ 'translate-x-0': open, '-translate-x-full': !open }"
        class="fixed md:translate-x-0 transition-transform duration-200 ease-in-out
               top-0 left-0 w-64 h-full bg-white text-gray-100 flex flex-col justify-between z-50"
    > -->
    <!-- <aside
        :class="{ 'translate-x-0': open, '-translate-x-full': !open }"
        class="fixed md:translate-x-0 transition-transform duration-200 ease-in-out
    ...
    > -->
        <!-- 上部タイトル -->
        <div>
            <!-- <div class="bg-white h-14 flex-none flex items-center justify-center text-center border-b border-gray-700"> -->
            <div class="bg-gray-800 h-14 flex-none flex items-center justify-center text-center border-b border-gray-700">
