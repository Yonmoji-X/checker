<nav class="fixed top-0 left-0 w-full z-50">
    ...
    <!-- 上部バー（モバイルのみ表示） -->
    <div class="md:hidden flex items-center justify-between bg-white h-14 p-4 shadow">
    ...
    <aside
        ...
        class="fixed md:translate-x-0 transition-transform duration-300 ease-in-out
